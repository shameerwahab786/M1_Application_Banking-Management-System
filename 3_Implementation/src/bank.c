...
Security
Insights
stepin_bank_management-system/3.Implementation/src/main.c
@Dishan13
Dishan13 Update main.c
Latest commit c0891be on Sep 7
 History
 1 contributor
748 lines (633 sloc)  23.7 KB
 ...
 * Author: Dishan Dev
 *
 * Created on 7 September, 2021, 4:56 PM
 */
...
int main()
{
    ...
    printf("\n\n\n\n\n\t\t\t\tEnter your correct password to login : ");
    scanf("%s",pass);
...
//Main Code
    ...
    scanf("%d", &option);
     system("CLS"); 
        ...
        printf("*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/\n");
        printf("Would you like to carry another transaction? : \n");
        printf("< 1 > Yes\n");
        printf("< 2 > No\n");
        scanf("%d", &choose);
         system("CLS"); 
...
void mainMenu() {
    ...
    printf("\n\t\t******Please choose a required option from below*******\n");
    printf("\n\t\t < 1 >  Check Balance\n");
    printf("\n\t\t < 2 >  Deposit money\n");
    printf("\n\t\t < 3 >  Withdraw money\n");
    printf("\n\t\t < 4 >  Exit\n\n");
...
void checkBalance(float balance) {
    printf("You chose to enquire your account balance !! \n");
...
float moneyDeposit(float balance) {
    ...
    printf("-_-_-_-_-_-_-_-_Your Balance is: $%.2f\n\n", balance);
    ...
    printf("-_-_-_-_-_-_-_-_Your New Balance is:   $%.2f\n\n", balance);
    return balance;
...
float moneyWithdraw(float balance) {
    ...
    printf("You chose to Withdraw your money!! \n");
    ...
    if (withdraw < balance) {
        ...
        printf("Please contact to our Customer Services to help you resolve the case\n");
